...
if __name__ == '__main__':
    logger = createLogger() # Pass this guy into everything (or make global variable I have no idea how python works)
    numClicks = 3
    # if len(sys.argv) > 1:
    #     numClicks = np.int_(sys.argv[1])
    logger.info("Starting data generation...")
    data = dataGenerator.generateData("https://championsqueue.gg/matches", numClicks, logger)
